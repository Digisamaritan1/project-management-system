...
import PromotionalCredit from './component/PromotionalCredit.vue';
...
import UpdateImportMemeberSubscription from './component/UpdateImportMemeberSubscription.vue';
...
export default {
    install(app) {
        ...
        app.component('UpdateImportMemeberSubscription', UpdateImportMemeberSubscription);
        ...
        app.component('PromotionalCredit', PromotionalCredit);
