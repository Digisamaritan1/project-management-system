<template>
    <DropDown :id="uniqueId" :bodyClass="{'countrycode__dropdown' : true}">
        <template #button>
            <div class="dropdown">
        ...
        <template #options>
            <DropDownOption
                ...
                :key="'phone'+index"
                @click="$emit('onSelect', activeCountry),selectedComapany(country),$refs[uniqueId].click()"
            >
...
<script setup>
    import { defineComponent, onMounted, ref,defineEmits ,defineProps , computed , inject, watch} from "vue";
    import DropDown from '@/components/molecules/DropDown/DropDown.vue'
    import DropDownOption from '@/components/molecules/DropDownOption/DropDownOption.vue'
    import InputText from '@/components/atom/InputText/InputText.vue';
    import { useCustomComposable } from "@/composable";
    import allCountries from "./allCountry.js";
    const arrow = require("@/assets/images/png/dropdownarrow.png")
