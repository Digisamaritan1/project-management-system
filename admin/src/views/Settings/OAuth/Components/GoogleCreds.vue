...
watch(
    () => props.credentials,
    (newCreds) => {
        formDatas.value.clientId.value = newCreds.clientId || "";
        formDatas.value.clientSecret.value = newCreds.clientSecret || "";
    },
...
async function save() {
    ...
    try {
        ...
        const backendVariables = [
            ...
            {
                variableName: "GOOGLE_OAUTH_URL",
                variableValue: "https://oauth2.googleapis.com/token",
            }
        ];
        ...
        const frontendVariables = [
            {
                variableName: "VUE_APP_GOOGLE_CLIENT_ID",
                variableValue: formDatas.value.clientId.value,
            }
        ];
